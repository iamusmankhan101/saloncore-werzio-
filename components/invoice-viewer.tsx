...
function WerzioLogo({ size = 36 }: { size?: number }) {
  return (
    <svg width={size * 3.2} height={size} viewBox="0 0 128 40" fill="none" xmlns="http://www.w3.org/2000/svg">
      {/* Icon mark */}
      <rect x="0" y="4" width="32" height="32" rx="9" fill="url(#logoGrad)" />
      <circle cx="16" cy="20" r="7" fill="none" stroke="white" strokeWidth="2.5" />
      <circle cx="16" cy="20" r="3" fill="white" />
      <path d="M16 13 L16 8" stroke="white" strokeWidth="2" strokeLinecap="round" />
      <path d="M21.5 15 L25 11.5" stroke="white" strokeWidth="2" strokeLinecap="round" />
      {/* Wordmark */}
      <text x="40" y="26" fontFamily="system-ui,-apple-system,sans-serif" fontSize="18" fontWeight="800" fill="#1a1a2e">Glow</text>
      <text x="80" y="26" fontFamily="system-ui,-apple-system,sans-serif" fontSize="18" fontWeight="800" fill="url(#textGrad)">Book</text>
      <defs>
        <linearGradient id="logoGrad" x1="0" y1="4" x2="32" y2="36" gradientUnits="userSpaceOnUse">
          <stop stopColor="#5B21B6" />
          <stop offset="1" stopColor="#9333EA" />
        </linearGradient>
        <linearGradient id="textGrad" x1="80" y1="0" x2="128" y2="0" gradientUnits="userSpaceOnUse">
          <stop stopColor="#5B21B6" />
          <stop offset="1" stopColor="#9333EA" />
        </linearGradient>
      </defs>
    ...
    >
      ...
      <style>{`
        @media print {
          ...
          #invoice-print-root { position: fixed; inset: 0; background: #fff; z-index: 9999; padding: 0; margin: 0; }
      ...
      <div id="invoice-print-root" onClick={(e) => e.stopPropagation()} style={{ width: "100%", maxWidth: 760, display: "flex", flexDirection: "column", gap: 12 }}>
        ...
        {/* Toolbar */}
        <div className="invoice-no-print" style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        ...
        {/* Invoice sheet */}
        <div className="invoice-sheet" style={{ background: "#fff", borderRadius: 16, boxShadow: "0 24px 80px rgba(0,0,0,0.3)", overflow: "hidden" }}>
