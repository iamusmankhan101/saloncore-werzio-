      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "48px 32px", display: "grid", gridTemplateColumns: "240px 1fr", gap: 48 }}>
        <aside style={{ position: "sticky", top: 48, height: "fit-content" }}>
          ...
          <nav style={{ display: "flex", flexDirection: "column", gap: 4 }}>
            ...
            <Link href="/data-processing" style={{ padding: "10px 16px", borderRadius: 8, fontSize: 14, color: "#7C3AED", background: "#f5f3ff", fontWeight: 600, textDecoration: "none" }}>Data Processing</Link>
            ...
            <Link href="/platform" style={{ padding: "10px 16px", borderRadius: 8, fontSize: 14, color: "#6b7280", textDecoration: "none" }}>Platform Terms</Link>
          </nav>
        </aside>
        ...
        <main style={{ background: "#fff", borderRadius: 16, padding: "48px 56px", boxShadow: "0 1px 3px rgba(0,0,0,0.05)", border: "1px solid #e8e8f0" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 12 }}>
            <div style={{ width: 40, height: 40, borderRadius: 10, background: "linear-gradient(135deg, #0284c7, #0ea5e9)", display: "flex", alignItems: "center", justifyContent: "center" }}>
              <Database size={20} color="#fff" />
            </div>
            <h1 style={{ fontSize: 32, fontWeight: 900, color: "#1a1a2e", margin: 0 }}>Data Processing Agreement</h1>
          </div>
          ...
          <p style={{ fontSize: 15, lineHeight: 1.8, color: "#4b5563" }}>
            This Data Processing Agreement outlines how Salon Central processes and protects your data in compliance with applicable data protection laws.
          </p>
