...
const TPL_CONFIG: TplCfg[] = [
  ...
  { key: "followup",     label: "Follow-up Message",       description: "Sent 24h after appointment is marked as completed",         vars: ["name","service","salon_name","feedback_link"], color: "#0284c7", icon: ThumbsUp },
