...
const rows = [
  {
    ...
    body: "Switch between All, Services, and Products tabs. See real-time stock levels on every product, category color badges, and out-of-stock indicators — all from the POS screen without leaving checkout.",
    visual: <CatalogPanel />,
  },
  {
    eyebrow: "Instant checkout",
    title: "Build a cart, apply discounts, and collect payment in seconds",
    body: "Add any mix of services and products to the cart. Apply a flat PKR or percentage discount on the fly. The total recalculates instantly — ready to charge the moment the client is done.",
    visual: <CartPanel />,
  },
  {
    eyebrow: "6 payment methods",
    title: "Accept cash, JazzCash, EasyPaisa, Raast, card, and bank transfer",
    body: "Pakistan-first payment options built in. Select the method the client prefers and the sale is recorded with full payment context — no manual note-taking or separate payment tracking needed.",
    visual: <PaymentPanel />,
  },
  {
    eyebrow: "Client history",
    title: "Every sale builds a richer client profile automatically",
    body: "Visit count, lifetime spend, last visit date, and loyalty points update the moment a sale is completed. Your team sees the client's full context every time they walk in — no manual updates required.",
    visual: <ClientPanel />,
  },
  {
    eyebrow: "Invoice and receipt",
    title: "Auto-numbered invoices and WhatsApp receipts sent instantly",
    body: "Each sale generates a branded invoice (SI-YEAR-XXXX format) with itemised services, products, discount, stylist name, and payment method. The receipt is sent to the client via WhatsApp automatically.",
    visual: <InvoicePanel />,
  },
  {
  ...
  },
  {
    ...
    body: "When an appointment is marked completed, a single tap opens POS with the client, stylist, and services pre-filled. No re-entry, no delay — the front desk keeps moving.",
